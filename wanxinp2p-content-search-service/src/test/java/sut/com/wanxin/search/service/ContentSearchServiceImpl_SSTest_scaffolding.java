...
public class ContentSearchServiceImpl_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.search.service.ContentSearchServiceImpl"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.wanxin.api.search.model.ProjectQueryParamsDTO", false, ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("java.util.Map", false, ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.apache.lucene.search.TotalHits", false, ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.elasticsearch.action.search.SearchResponse", false, ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.elasticsearch.client.RestHighLevelClient", false, ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.elasticsearch.search.SearchHit", false, ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.elasticsearch.search.SearchHits", false, ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ContentSearchServiceImpl_SSTest_scaffolding.class.getClassLoader()); 
