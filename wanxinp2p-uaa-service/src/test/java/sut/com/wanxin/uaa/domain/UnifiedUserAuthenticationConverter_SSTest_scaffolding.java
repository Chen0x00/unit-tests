...
public class UnifiedUserAuthenticationConverter_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.uaa.domain.UnifiedUserAuthenticationConverter"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.wanxin.uaa.domain.UnifiedUserDetails", false, UnifiedUserAuthenticationConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("java.util.Map", false, UnifiedUserAuthenticationConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.Authentication", false, UnifiedUserAuthenticationConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.authority.SimpleGrantedAuthority", false, UnifiedUserAuthenticationConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.userdetails.UserDetailsService", false, UnifiedUserAuthenticationConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(UnifiedUserAuthenticationConverter_SSTest_scaffolding.class.getClassLoader() ,
      "org.springframework.security.core.authority.SimpleGrantedAuthority"
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UnifiedUserAuthenticationConverter_SSTest_scaffolding.class.getClassLoader()); 
