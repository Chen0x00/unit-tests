...
public class RestOAuthExceptionJacksonSerializer_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.uaa.config.RestOAuthExceptionJacksonSerializer"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.core.JsonGenerator", false, RestOAuthExceptionJacksonSerializer_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.fasterxml.jackson.databind.SerializerProvider", false, RestOAuthExceptionJacksonSerializer_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.wanxin.uaa.config.RestOAuthExceptionJacksonSerializer", false, RestOAuthExceptionJacksonSerializer_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(RestOAuthExceptionJacksonSerializer_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RestOAuthExceptionJacksonSerializer_SSTest_scaffolding.class.getClassLoader()); 
