...
public class IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.uaa.domain.IntegrationUserDetailsAuthenticationHandler"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.wanxin.api.account.model.AccountDTO", false, IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.wanxin.api.account.model.AccountLoginDTO", false, IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.wanxin.common.domain.RestResponse", false, IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.wanxin.uaa.agent.AccountApiAgent", false, IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.context.ApplicationContext", false, IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.authentication.UsernamePasswordAuthenticationToken", false, IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(IntegrationUserDetailsAuthenticationHandler_SSTest_scaffolding.class.getClassLoader()); 
