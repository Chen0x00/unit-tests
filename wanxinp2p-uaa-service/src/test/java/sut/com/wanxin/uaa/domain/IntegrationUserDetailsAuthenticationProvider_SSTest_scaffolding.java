...
public class IntegrationUserDetailsAuthenticationProvider_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.uaa.domain.IntegrationUserDetailsAuthenticationProvider"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.wanxin.uaa.domain.IntegrationUserDetailsAuthenticationHandler", false, IntegrationUserDetailsAuthenticationProvider_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.wanxin.uaa.domain.IntegrationWebAuthenticationDetails", false, IntegrationUserDetailsAuthenticationProvider_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("java.util.Map", false, IntegrationUserDetailsAuthenticationProvider_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.authentication.UsernamePasswordAuthenticationToken", false, IntegrationUserDetailsAuthenticationProvider_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.userdetails.UserDetails", false, IntegrationUserDetailsAuthenticationProvider_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(IntegrationUserDetailsAuthenticationProvider_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(IntegrationUserDetailsAuthenticationProvider_SSTest_scaffolding.class.getClassLoader()); 
