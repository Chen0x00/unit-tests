...
public class RestOAuth2WebResponseExceptionTranslator_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.uaa.config.RestOAuth2WebResponseExceptionTranslator"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.Exception", false, RestOAuth2WebResponseExceptionTranslator_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.web.util.ThrowableAnalyzer", false, RestOAuth2WebResponseExceptionTranslator_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(RestOAuth2WebResponseExceptionTranslator_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RestOAuth2WebResponseExceptionTranslator_SSTest_scaffolding.class.getClassLoader()); 
