...
public class SecurityConfig_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.uaa.config.SecurityConfig"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.wanxin.uaa.config.SecurityConfig", false, SecurityConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.config.annotation.web.builders.WebSecurity", false, SecurityConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.config.annotation.web.builders.WebSecurity$IgnoredRequestConfigurer", false, SecurityConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(SecurityConfig_SSTest_scaffolding.class.getClassLoader() ,
      "org.springframework.security.config.annotation.web.builders.WebSecurity"
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SecurityConfig_SSTest_scaffolding.class.getClassLoader()); 
