...
public class GlobalExceptionHandler_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.transaction.common.intercept.GlobalExceptionHandler"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.wanxin.common.domain.ErrorCode", false, GlobalExceptionHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    ...
    mock(Class.forName("javax.servlet.http.HttpServletResponse", false, GlobalExceptionHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(GlobalExceptionHandler_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GlobalExceptionHandler_SSTest_scaffolding.class.getClassLoader()); 
