...
public class DateUtil_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.common.util.DateUtil"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.text.DateFormat", false, DateUtil_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
