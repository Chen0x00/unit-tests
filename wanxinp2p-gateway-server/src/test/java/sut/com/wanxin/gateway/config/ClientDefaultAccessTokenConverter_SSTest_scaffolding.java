...
public class ClientDefaultAccessTokenConverter_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.gateway.config.ClientDefaultAccessTokenConverter"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Date", false, ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("java.util.Map", false, ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.Authentication", false, ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.core.GrantedAuthority", false, ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.oauth2.common.OAuth2AccessToken", false, ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.oauth2.provider.OAuth2Authentication", false, ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.oauth2.provider.OAuth2Request", false, ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.security.oauth2.provider.token.UserAuthenticationConverter", false, ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ClientDefaultAccessTokenConverter_SSTest_scaffolding.class.getClassLoader()); 
