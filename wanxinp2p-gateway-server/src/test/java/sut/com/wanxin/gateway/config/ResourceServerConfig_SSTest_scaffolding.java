...
public class ResourceServerConfig_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.gateway.config.ResourceServerConfig"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.springframework.security.oauth2.config.annotation.web.configurers.ResourceServerSecurityConfigurer", false, ResourceServerConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(ResourceServerConfig_SSTest_scaffolding.class.getClassLoader() ,
      "org.springframework.security.oauth2.config.annotation.web.configurers.ResourceServerSecurityConfigurer"
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ResourceServerConfig_SSTest_scaffolding.class.getClassLoader()); 
