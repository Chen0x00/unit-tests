...
public class RestOAuth2AuthExceptionEntryPoint_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.gateway.config.RestOAuth2AuthExceptionEntryPoint"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("javax.servlet.ServletOutputStream", false, RestOAuth2AuthExceptionEntryPoint_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, RestOAuth2AuthExceptionEntryPoint_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletResponse", false, RestOAuth2AuthExceptionEntryPoint_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(RestOAuth2AuthExceptionEntryPoint_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RestOAuth2AuthExceptionEntryPoint_SSTest_scaffolding.class.getClassLoader()); 
