...
public class WebMvcConfiguration_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.consumer.config.WebMvcConfiguration"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.springframework.web.servlet.config.annotation.InterceptorRegistration", false, WebMvcConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.web.servlet.config.annotation.InterceptorRegistry", false, WebMvcConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.web.servlet.config.annotation.ResourceHandlerRegistration", false, WebMvcConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.web.servlet.config.annotation.ResourceHandlerRegistry", false, WebMvcConfiguration_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(WebMvcConfiguration_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(WebMvcConfiguration_SSTest_scaffolding.class.getClassLoader()); 
