...
public class DepositoryNotifyVerificationInterceptor_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.depository.interceptor.DepositoryNotifyVerificationInterceptor"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.wanxin.depository.service.ConfigService", false, DepositoryNotifyVerificationInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("java.io.PrintWriter", false, DepositoryNotifyVerificationInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, DepositoryNotifyVerificationInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletResponse", false, DepositoryNotifyVerificationInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(DepositoryNotifyVerificationInterceptor_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DepositoryNotifyVerificationInterceptor_SSTest_scaffolding.class.getClassLoader()); 
