...
public class WebConfig_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.depository.config.WebConfig"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.springframework.web.servlet.config.annotation.InterceptorRegistration", false, WebConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    ...
    mock(Class.forName("org.springframework.web.servlet.config.annotation.ResourceHandlerRegistration", false, WebConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.web.servlet.config.annotation.ResourceHandlerRegistry", false, WebConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }
