...
public class SignatureInterceptor_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.wanxin.depository.interceptor.SignatureInterceptor"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.wanxin.depository.service.ConfigService", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("java.nio.charset.Charset", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("okhttp3.HttpUrl", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("okhttp3.Interceptor$Chain", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("okhttp3.MediaType", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("okhttp3.Request", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("okhttp3.Request$Builder", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("okhttp3.Response", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("okhttp3.Response$Builder", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("okhttp3.ResponseBody", false, SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(SignatureInterceptor_SSTest_scaffolding.class.getClassLoader() ,
      "okhttp3.Response",
      "okhttp3.MediaType",
      "okhttp3.Request",
      "okhttp3.HttpUrl"
  ...
  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SignatureInterceptor_SSTest_scaffolding.class.getClassLoader()); 
